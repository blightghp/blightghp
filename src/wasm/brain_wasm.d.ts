...
export class WasmNeuralEngine {
    ...
    chemical_cleft_concentration(): Float64Array;
    chemical_cleft_moles(): Float64Array;
    chemical_latest_release_moles(): Float64Array;
    chemical_latest_release_time_seconds(): Float64Array;
    chemical_presynaptic_spike_counts(): Uint32Array;
    chemical_receptor_bound_moles(): Float64Array;
    chemical_receptor_occupancy_fraction(): Float64Array;
    chemical_release_event_indices(): Uint32Array;
    chemical_solver_step_index(): bigint;
    chemical_state_hash(): string;
    chemical_time_seconds(): number;
    chemical_total_released_moles(): Float64Array;
    chemical_vesicle_available_fraction(): Float64Array;
    chemical_vesicle_utilization_fraction(): Float64Array;
...
export interface InitOutput {
    ...
    readonly wasmneuralengine_chemical_cleft_concentration: (a: number) => [number, number];
    readonly wasmneuralengine_chemical_cleft_moles: (a: number) => [number, number];
    readonly wasmneuralengine_chemical_latest_release_moles: (a: number) => [number, number];
    readonly wasmneuralengine_chemical_latest_release_time_seconds: (a: number) => [number, number];
    readonly wasmneuralengine_chemical_presynaptic_spike_counts: (a: number) => [number, number];
    readonly wasmneuralengine_chemical_receptor_bound_moles: (a: number) => [number, number];
    readonly wasmneuralengine_chemical_receptor_occupancy_fraction: (a: number) => [number, number];
    readonly wasmneuralengine_chemical_release_event_indices: (a: number) => [number, number];
    readonly wasmneuralengine_chemical_solver_step_index: (a: number) => bigint;
    readonly wasmneuralengine_chemical_state_hash: (a: number) => [number, number];
    readonly wasmneuralengine_chemical_time_seconds: (a: number) => number;
    readonly wasmneuralengine_chemical_total_released_moles: (a: number) => [number, number];
    readonly wasmneuralengine_chemical_vesicle_available_fraction: (a: number) => [number, number];
    readonly wasmneuralengine_chemical_vesicle_utilization_fraction: (a: number) => [number, number];
