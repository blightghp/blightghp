...
**Revisão:** 3 · 2 de setembro de 2026

**Produto declarado nos manifests:** `0.9.0`

**Baseline promovida:** `0.8`

**Desenvolvimento:** R09-A..R09-F e R10-A..R10-D concluídos; R10-E e R10-F com evidência fechada

**Próximo gate global:** `R10-H` · pipeline dormente de asset externo antes da captura R10-G e da promoção R10-P
...
| PROMETHEUS | `engine/` com oito crates; Φ-0 concluída e Φ-1 com grafo compilado/executor `wgpu` 30; ponte científica ainda pendente | [índice arquitetural](../specifications/prometheus/README.md) |
...
| 2 | `R10-F` · UI/interação | evidência fechada; promoção pendente | modos, escala, foco, proveniência, toque e navegação acessível |
...
```mermaid
flowchart LR
    D["R10-D ✓"] --> E["R10-E · evidência fechada"] --> F["R10-F · evidência fechada"] --> H["R10-H"]
...
| R10-F · UI/interação | evidência fechada; promoção pendente | UI-031..037 e UX-003, toque, árvore de acessibilidade, `390×844` e movimento reduzido verificados; resta somente a promoção agregada | manter painel atual |
